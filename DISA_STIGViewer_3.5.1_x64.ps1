...
Try {
    ...
    [String]$appVendor = 'DISA'
    [String]$appName = 'STIG Viewer 3'
    [String]$appVersion = '3.5.1'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    ...
    [String]$installName = 'DISA_STIG_Viewer-3_3.5.1_x64'
    [String]$installTitle = 'DISA_STIG_Viewer-3_3.5.1_x64'
