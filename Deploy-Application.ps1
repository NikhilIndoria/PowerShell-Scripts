...
Try {
    ...
    [String]$appVendor = 'Bosch'
    [String]$appName = 'Configuration_Manager'
    [String]$appVersion = '7.76.0046'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '11/08/2024'
    [String]$appScriptAuthor = 'Nikhil Indoria'
    [string]$PackagingCompany = 'Unisys'
    [string]$Licensed = 'NA'
    [String]$pkgDetails = 'Bosch_Configuration_Manager_7.76.0046_x64'
    ##*===============================================
    ## Variables: Install Titles (Only set here to override defaults set by the toolkit)
    [String]$installName = 'Bosch_Configuration_Manager_7.76.0046_x64'
    [String]$installTitle = 'Bosch_Configuration_Manager_7.76.0046_x64'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -path "$dirFiles\Setup_ConfigManager_7.76.46_signed.exe" -Parameters '/S' -WindowStyle Hidden
