...
Try {
    ...
    [String]$appVendor = 'Zoho Corporation Pvt. Ltd'
    [String]$appName = 'ManageEngine_Endpoint_Central'
    [String]$appVersion = '11.4.2528.02'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    ...
    [String]$installName = 'Zoho_Corporation_ManageEngine_Endpoint_Central_11.4.2528.02_x64'
    [String]$installTitle = 'Zoho_Corporation_ManageEngine_Endpoint_Central_11.4.2528.02_x64'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path "$dirFiles\ManageEngine_Endpoint_Central_EvaluationKit.exe" -Parameters '/S' -Wait
        ...
        Start-Process -FilePath "C:\Program Files (x86)\InstallShield Installation Information\{BCEF6F6B-E530-4D5E-8DB7-C54F96DB9D2A}\ManageEngine_Endpoint_Central_EvaluationKit.exe" -ArgumentList "-runfromtemp -l0x0409 uninstall -l9 -removeonly -silent" -Wait
