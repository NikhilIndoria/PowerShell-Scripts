...
Try {
    ...
    [String]$appVendor = 'DAX_Studio'
    [String]$appName = 'DAX_Studio'
    [String]$appVersion = '3.3.2.1107'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '19/08/2024'
    [String]$appScriptAuthor = 'Nikhil Indoria'
    [string]$PackagingCompany = 'Unisys'
    [string]$Licensed = 'NA'
    [String]$pkgDetails = 'DAX_Studio_3.3.2.1107_x64'
    ##*===============================================
    ## Variables: Install Titles (Only set here to override defaults set by the toolkit)
    [String]$installName = 'DAX_Studio_3.3.2.1107_x64'
    [String]$installTitle = 'DAX_Studio_3.3.2.1107_x64'
