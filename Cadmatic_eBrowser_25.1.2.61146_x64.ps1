...
Try {
    ...
    [String]$appVendor = 'CADMATIC'
    [String]$appName = 'eBrowser'
    [String]$appVersion = '25.1.2.61146'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    ...
    [String]$installName = 'CADMATIC_eBrowser_25.1.2.61146_x64'
    [String]$installTitle = 'CADMATIC_eBrowser_25.1.2.61146_x64'
